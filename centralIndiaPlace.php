...
<div class="container">
    ...
    <h1 style="margin-top:50px;">Central India Places</h1>
    <!-- Vertical Tabs -->
    <div class="jq-tab-wrapper" id="verticalTab">
        <div class="jq-tab-menu">
            <div class="jq-tab-title active" data-tab="1">Amarkantak</div>
            <div class="jq-tab-title" data-tab="2">Bhopal</div>
            <div class="jq-tab-title" data-tab="3">Gwalior</div>
			<div class="jq-tab-title" data-tab="4">Jabalpur</div>
			<div class="jq-tab-title" data-tab="5">Omkareshwar</div>
		
        </div>
        <div class="jq-tab-content-wrapper">
            <div class="jq-tab-content active" data-tab="1">	<div class="placeTourismName">Amarkantak Tourism -- "King of Pilgrimages"
...
sight of the river is enough. Amarkantak also nds a mention in Mahabharat, where Pandavas made one of their homes during their exile.
            ...
            <div class="jq-tab-content" data-tab="2">	<div class="placeTourismName">Bhopal Tourism -- "City oflakes"
								</div><!---- end of placeTourismName------------------->
...
This place is a true haven for art, culture and tradition.
            ...
            <div class="jq-tab-content" data-tab="3"><div class="placeTourismName">Gwalior Tourism -- "Tourism Capital of Madhya Pradesh"
								</div><!---- end of placeTourismName------------------->
...
in Gwalior. The great sarod player, Amjad Khan, belongs to Gwalior and his grandfather, Ghulam Ali Khan Bangash became the court musician of Gwalior.
			...
			<div class="jq-tab-content" data-tab="4">		<div class="placeTourismName">Jabalpur Tourism -- "The land ofglittering Marble Rocks"
								</div><!---- end of placeTourismName------------------->
...
maintain this industrial city's connection with nature and are certain to ignite imaginations in the busy minds and create a sense of relaxation and rejuvenation.
			...
			<div class="jq-tab-content" data-tab="5">	<div class="placeTourismName">Omkareshwar Tourism -- "Mini Varanasi"
								</div><!---- end of placeTourismName------------------->
